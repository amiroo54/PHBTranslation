...
<figcaption>{{Spellcaster}} {{Multiclass}} : {{SpellSlots}} به ازای هر {{Level}} {{Spell}}</figcaption>
</figure>
...
**{{SpellSlots}}.** {{SpellSlots}} موجود را با جمع زدن چیزهای زیر به دست می‌آوری:

- همه {{Level}}‌ها در {{Class}}‌های {{Bard}}، {{Cleric}}، {{Druid}}، {{Sorcerer}} و {{Wizard}}.

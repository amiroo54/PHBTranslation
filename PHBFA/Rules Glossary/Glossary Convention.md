...
- **عدم وجود اصطلاحات منسوخ.** {{RulesGlossary}} فقط شامل اصطلاحات و تعاریف قوانین فعلی هستند. اگر دنبال یک اصطلاح از نسخه‌های قدیمی‌تر قوانین {{Edition}} پنجم به {{Index}} مراجعه شود.
